    ...
    <main>
      ...
      <section className="section-bg-dark px-4 py-16 text-center text-white md:px-8 md:py-20 lg:px-12 lg:py-24">
        ...
        <div className="m-auto grid max-w-6xl gap-10 text-left lg:grid-cols-2">
          ...
          <div className="frosted-glass-dark space-y-4 p-5">
            <div>
              <h3 className="mb-4 text-2xl leading-tight md:text-3xl lg:text-4xl">Nephelo Forms</h3>
              <p>A basic drag and drop form builder.</p>
            </div>
            <div>
              <h4 className="text-base md:text-lg">Urls</h4>
              <ul>
                <li>
                  Website: <a href="https://nephelo.io">https://nephelo.io</a>
                </li>
                <li>
                  Github:{' '}
                  <a href="https://github.com/Burtonium/nephelo-forms">
                    https://github.com/Burtonium/nephelo-forms
                  </a>
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ol className="list-disc pt-1 pl-5">
                <li>
                  Working with{' '}
                  <a rel="noopener" href="https://trpc.io/">
                    tRPC
                  </a>{' '}
                  was great.
                </li>
                <li>Nextjs component caching issues are a pain.</li>
                <li>
                  I don't like ORMs because they abstract out powerful Postresql functionality but{' '}
                  <a rel="noopener" href="https://prisma.io/">
                    Prisma
                  </a>{' '}
                  had nice features.
                </li>
          ...
          <div className="frosted-glass-dark space-y-4 p-5">
            <div>
              <h3 className="mb-4 text-2xl leading-tight md:text-3xl lg:text-4xl">Profane</h3>
              <p>An htmx experiment making a forum where profanity is required.</p>
            </div>
            <div>
              <h4 className="text-base md:text-lg">Urls</h4>
              <ul>
                <li>
                  Website: <a href="https://profane.fly.dev/">https://profane.fly.dev/</a> (Free
                  tier is slow)
                </li>
                <li>
                  Github:{' '}
                  <a href="https://github.com/Burtonium/profane">
                    https://github.com/Burtonium/profane
                  </a>
                </li>
              </ul>
            </div>
            ...
            <div>
              <h4 className="text-base md:text-lg">Key takeaways</h4>
              <ol className="list-disc pt-1 pl-5">
                <li>HTMX is great when you want very minimal frontend code.</li>
                <li>
                  Hypermedia as the Engine of Application State (HATEOAS) makes a lot of state
                  management boilerplate unnecessary.
                </li>
              </ol>
            </div>
          </div>
